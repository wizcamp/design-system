...
| Admin Shell | [admin-shell/index.md](admin-shell/index.md) | `AdminSidebar` → [admin-sidebar.md](admin-shell/admin-sidebar.md); `AdminHeader` → [admin-header.md](admin-shell/admin-header.md) |
